window.questions = [
  {
    ...
    options: [
      { text: "先记住这笔账，等时机成熟再用结果打脸", effects: { rational: 3, calm: 3, ambitious: 4, disguised: 2, execution: 3, realism: 2, egoism: 2, decisiveness: 2, stressTolerance: 2 } },
      { text: "当场怼回去，气势不能输", effects: { emotional: 3, impulsive: 4, rebellious: 3, social: 2, courage: 3, decisiveness: 2 } },
  ...
  },
  {
    ...
    options: [
      { text: "我来重新分工，确保事情还能推进", effects: { orderly: 3, execution: 4, rational: 3, calm: 2, realism: 3, decisiveness: 3, stressTolerance: 1 } },
      { text: "直接点名指出问题，别再装没看见", effects: { impulsive: 3, rebellious: 2, moral: 3, execution: 2, courage: 2 } },
  ...
  },
  {
    ...
    options: [
      { text: "规则先立住，不然最后谁都说不清", effects: { orderly: 4, moral: 3, conformist: 2, rational: 2, realism: 2, decisiveness: 1 } },
      { text: "只要结果对，过程灵活一点没关系", effects: { rebellious: 4, rational: 2, ambitious: 3, disguised: 1, realism: 3, decisiveness: 2 } },
  ...
  },
  {
    ...
    text: "你更容易因为什么突然失控？",
    options: [
      { text: "被人反复否定能力", effects: { ambitious: 4, emotional: 2, impulsive: 3, courage: 1, stressTolerance: 1 } },
      { text: "身边人受委屈却没人站出来", effects: { altruistic: 4, moral: 3, impulsive: 2, emotional: 2, empathy: 4 } },
  ...
  },
  {
    ...
    options: [
      { text: "嘴上说没事，回去自己内耗很久", effects: { emotional: 4, solitary: 3, romance: 4, dependency: 3, disguised: 2 } },
      { text: "争取一次，不行就体面退场", effects: { rational: 3, calm: 3, romance: 3, moral: 1, courage: 1, decisiveness: 2 } },
  ...
  },
  {
    ...
    options: [
      { text: "先问清楚值不值得，再决定上不上", effects: { rational: 4, calm: 3, execution: 1, realism: 3, decisiveness: 1 } },
      { text: "去啊，人生就是得有点节目效果", effects: { humorous: 4, impulsive: 3, social: 3, rebellious: 1, absurdity: 4, courage: 1 } },
  ...
  },
  {
    ...
    text: "你最常用哪种方式保护自己？",
    options: [
      { text: "先把情绪收起来，不让别人看懂我", effects: { disguised: 4, calm: 2, solitary: 2, realism: 1, egoism: 1 } },
  ...
  },
  {
    ...
    options: [
      { text: "先做长期计划，一步步压过去", effects: { execution: 4, rational: 3, ambitious: 4, orderly: 2, realism: 3, decisiveness: 2 } },
      { text: "边做边冲，机会来了先抓住再说", effects: { impulsive: 4, ambitious: 3, rebellious: 2, execution: 2, courage: 2, decisiveness: 3 } },
  ...
  },
  {
    ...
    options: [
      { text: "很自然接住，全场气氛我来带", effects: { social: 4, humorous: 3, calm: 1, courage: 2, stressTolerance: 2 } },
  ...
  },
  {
    ...
    options: [
      { text: "他是不是真的值得我帮", effects: { rational: 3, moral: 2, calm: 2, realism: 2, egoism: 1 } },
      { text: "只要我能帮上，就先帮了再说", effects: { altruistic: 4, emotional: 2, social: 2, empathy: 4 } },
  ...
  },
  {
    ...
    text: "你最容易被哪种人吸引？",
    options: [
      { text: "有点危险感、很特别、别人搞不定的那种", effects: { romance: 4, dependency: 2, rebellious: 2, emotional: 2, absurdity: 2, courage: 1 } },
      { text: "靠谱、稳、让我有安全感的人", effects: { romance: 3, dependency: 4, orderly: 3, calm: 2, conformist: 1 } },
  ...
  },
  {
    ...
    options: [
      { text: "脑子清楚，关键时刻不乱", effects: { rational: 4, calm: 4, execution: 2, stressTolerance: 3 } },
      { text: "重情重义，别人靠得住我", effects: { altruistic: 4, moral: 3, emotional: 3, dependency: 2, empathy: 3 } },
  ...
  {
    id: 13,
    text: "当所有人都说你想做的事不可能时，你更可能怎么做？",
    options: [
      { text: "先算资源和代价，真不划算就撤", effects: { realism: 4, rational: 3, calm: 2, decisiveness: 1 } },
      { text: "我偏要试，至少不能还没上场就认输", effects: { courage: 4, rebellious: 2, ambitious: 2, stressTolerance: 1 } },
  ...
  },
  {
    ...
    text: "你更容易相信哪句话？",
    options: [
      { text: "先活下来，再谈理想", effects: { realism: 4, calm: 2, execution: 2, egoism: 1 } },
      { text: "人生太正常就没意思了", effects: { absurdity: 4, humorous: 3, rebellious: 1 } },
  ...
  {
    id: 15,
    text: "当朋友情绪崩掉来找你时，你更像哪种反应？",
    options: [
      { text: "先安静听完，尽量让他感觉自己被理解", effects: { empathy: 4, emotional: 2, altruistic: 2 } },
      { text: "我会给方案，先把问题解决掉", effects: { rational: 3, realism: 2, execution: 2, stressTolerance: 1 } },
  ...
  {
    id: 16,
    text: "如果一件事只能保你自己，或者顺手拉别人一把，你更可能？",
    options: [
      { text: "先保自己，站稳了再说别的", effects: { egoism: 4, realism: 2, calm: 1, decisiveness: 2 } },
      { text: "如果我能做到，我会一起带上", effects: { empathy: 4, altruistic: 3, courage: 1 } },
  ...
  {
    id: 17,
    text: "你拿到了一个梦寐以求的发展机会，但代价是要去很远的城市，和现在深爱的人长期分开。你会怎么选？",
    options: [
      { text: "选事业，机会错过可能就没了", effects: { ambitious: 4, rational: 3, execution: 3, realism: 3, egoism: 2, decisiveness: 3 } },
      { text: "选爱情，人比机会更重要", effects: { emotional: 3, romance: 4, dependency: 3, empathy: 2, decisiveness: 2 } },
  ...
  {
    id: 18,
    text: "一辆失控的列车正冲向前方轨道上的 5 个人。你站在拉杆旁，只要拉下拉杆，列车就会转向另一条轨道，那条轨道上有 1 个人，但那个人是你最好的朋友。你会怎么做？",
    options: [
      { text: "拉下拉杆，牺牲 1 个人救 5 个人", effects: { rational: 4, execution: 3, realism: 3, moral: 1, decisiveness: 3, stressTolerance: 3 } },
      { text: "不拉，让事情自然发生", effects: { orderly: 3, conformist: 2, calm: 1, courage: 0, execution: 0, decisiveness: 1 } },
      { text: "我会先犹豫，直到错过时机", effects: { emotional: 3, dependency: 2, execution: 0, courage: 0, decisiveness: 0, stressTolerance: 0 } },
      { text: "我会想别的办法，哪怕成功率很低", effects: { rebellious: 3, courage: 2, absurdity: 1, emotional: 1, realism: 0, decisiveness: 2 } },
      { text: "我会尝试让火车漂移，干脆六个一起压", effects: { absurdity: 5, humorous: 2, rebellious: 3, impulsive: 2, moral: 0, realism: 0 } },
      { text: "我会崩溃，根本做不了决定", effects: { emotional: 4, dependency: 2, execution: 0, courage: 0, empathy: 2, stressTolerance: 0, decisiveness: 0 } }
    ]
  }
];
